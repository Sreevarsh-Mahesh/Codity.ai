...
const toPx = (v: number | string | { x?: number; y?: number } | undefined): number => {
  if (v == null) return 0;
  if (typeof v === 'number') return v;
  if (typeof v === 'object' && 'x' in v) return v.x ?? 0;
...
const PrismaticBurst = ({
  ...
  useEffect(() => {
    ...
    const ox = typeof offset === 'object' && offset !== null ? toPx(offset.x) : 0;
    const oy = typeof offset === 'object' && offset !== null ? toPx(offset.y) : 0;
